...
<div class="container fs-14">
    <div class="row my-2">
        <div class="col-md-12">
            ...
            <a href="/destination" class="text-decoration-none txt-black">Điểm đến</a>
            <span class="mx-2">></span>
            <a href="/" class="text-decoration-none txt-black">
                ...
                <div class="card">
                    <div class="tour-img">
                        <div style="position: relative;">
                            <a href="<c:url value=" /product" />?productId=${p.product_id}" style="
                               ...
                               overflow: hidden;
                               ">
                                <img src="${p.image}" class="card-img-top" alt="tour-img"
                                     style="height: 275px"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-baseline">
                            ...
                            <a href="<c:url value=" /product" />?productId=${p.product_id}"
                               class="btn-details
